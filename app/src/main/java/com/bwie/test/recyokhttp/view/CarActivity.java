...
import com.bwie.test.recyokhttp.adapter.CarAdapter;
import com.bwie.test.recyokhttp.bean.Child;
import com.bwie.test.recyokhttp.bean.Group;
...
public class CarActivity extends AppCompatActivity {
    ...
    CarAdapter adapter;//自定义baseExpandable适配器
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        adapter.setOnNumChangeListener(new CarAdapter.onNumChangeListener() {
            @Override
            public void onNumChange(int groupID, int childID, boolean isAdd) {
                ...
                if (isAdd){//加
                    ...
                    if (num == 1){//数量为1给出提示
                        Toast.makeText(CarActivity.this, "受不了了，不能再少了", Toast.LENGTH_SHORT).show();
                    }else{//在数据源中该商品数量自减1
                        groups.get(groupID).getChildren().get(childID).setNum(--num);
                    }
                }
        ...
        //自定义商铺和商品多选框点击回调
        adapter.setmOnCheckChangeListener(new CarAdapter.onCheckChangeListener() {
            @Override
        ...
        btnBuy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(CarActivity.this, "当前总金额:"+money, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        //自定义回调更新总价
        adapter.setmOnShouldChangeMoneyListener(new CarAdapter.onShouldChangeMoneyListener() {
            @Override
    ...
    private void initData() {
        ...
        adapter = new CarAdapter(this,groups);
